...
const ExamResults = () => {
  ...
  // --- Helper: Convert Option IDs back to Text ---
  ...
  const getCorrectAnswerText = (options, correctIds) => {
    if (!correctIds || correctIds.length === 0) return "N/A";
    ...
    <div className="exam-results-container">
      <div className="exam-results-card">
        ...
        <div className="action-buttons">
          ...
          >
            <FaRedo style={{marginRight:'8px'}}/> Retake / Catalog
          </button>
          
          <button 
            className="progress-btn" 
            onClick={() => navigate("/progress")}
            style={{backgroundColor: '#3B82F6', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px'}}
          >
